...
**Report contract:** write your full report as markdown to /tmp/codex-research/codex-response-11B04D2A.md with this structure:
...
Reply in the pane only with 'DONE: /tmp/codex-research/codex-response-11B04D2A.md'.
